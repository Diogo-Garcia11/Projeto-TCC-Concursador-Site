<nav x-data="{ open: false }" class="font-bigShoulders bg-steelblue dark:border-gray-700 ">
    ...
    <div :class="{'block': open, 'hidden': ! open}" class="hidden sm:hidden">
        ...
        <div class="pt-4 pb-1 border-t border-gray-200 dark:border-gray-600">
            <div class="px-4">
                <div class="font-medium text-base text-gray-400 dark:text-gray-700">{{ Auth::user()->name }}</div>
