        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            ...
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg p-[80px]">
                ...
                <div class="mt-6">
                    <ul class="text-black">
                        <li class="mb-2">
                            <p>1) Seixas era homem honesto; mas ao atrito da secretaria e ao calor das salas, sua honestidade havia tomado essa têmpera flexível da cera que se molda às fantasias da vaidade e aos reclamos da ambição.
                    ...
                    <div class="mt-6">
                        <ul class="text-black">
                            <li class="mb-2">
                                <p>2) O Parnasianismo buscava afastar-se do sentimentalismo romântico, propondo uma poesia com rigor estético. Esse movimento é representado no poema abaixo:



                                    "E é só. É só? E basta o que não é?

                                    Bastante és tu, de olhos claros, morena.

                                    Pondo a boca no pão e os olhos na pena."



                                    O poema destaca-se por sua:

                                </p>
                            </li>
                            <li class="radio-container"><input type="radio" name="questao-2" value="0"
                                    onclick="checkAnswer(event, 'questao-2')"><span class="radio-text">A) sublimação dos sentimentos humanos.</span></li>
                            <li class="radio-container"><input type="radio" name="questao-2" value="1"
                                    onclick="checkAnswer(event, 'questao-2')"><span class="radio-text">B) valorização da forma e da perfeição estética.</span></li>
                            <li class="radio-container"><input type="radio" name="questao-2" value="0"
                                    onclick="checkAnswer(event, 'questao-2')"><span class="radio-text">C) crítica à sociedade burguesa.</span></li>
                            <li class="radio-container"><input type="radio" name="questao-2" value="0"
                                    onclick="checkAnswer(event, 'questao-2')"><span class="radio-text">D) reflexão sobre o papel do poeta na modernidade.</span></li>
                            <li class="radio-container"><input type="radio" name="questao-2" value="0"
                                    onclick="checkAnswer(event, 'questao-2')"><span class="radio-text">E) preocupação com temas existenciais.</span></li>
                        </ul>
                        <ul class="text-black">
                            <li class="mb-2">
                                <p>3) “Dizem que em sonhos de futuro ardente, / Das belas artes divaguei um dia; / Com o pincel do sonho, simplesmente, / Um quadro de esperanças concebia.”



                                    O poema remete a características do movimento:

                                </p>
                            </li>
                            <li class="radio-container"><input type="radio" name="questao-3" value="0"
                                    onclick="checkAnswer(event, 'questao-3')"><span class="radio-text">A) Modernismo.</span></li>
                            <li class="radio-container"><input type="radio" name="questao-3" value="0"
                                    onclick="checkAnswer(event, 'questao-3')"><span class="radio-text">B) Barroco.</span></li>
                            <li class="radio-container"><input type="radio" name="questao-3" value="1"
                                    onclick="checkAnswer(event, 'questao-3')"><span class="radio-text">C) Romantismo.</span></li>
                            <li class="radio-container"><input type="radio" name="questao-3" value="0"
                                    onclick="checkAnswer(event, 'questao-3')"><span class="radio-text">D) Simbolismo.</span></li>
                            <li class="radio-container"><input type="radio" name="questao-3" value="0"
                                    onclick="checkAnswer(event, 'questao-3')"><span class="radio-text">E) Naturalismo.</span></li>
                        </ul>
                        <ul class="text-black">
                            <li class="mb-2">
                                <p>4) Entre os textos literários abaixo, qual deles pode ser considerado um marco do Modernismo no Brasil, com sua linguagem inovadora e temática nacionalista?</p>
                            </li>
                            <li class="radio-container"><input type="radio" name="questao-4" value="0"
                                    onclick="checkAnswer(event, 'questao-4')"><span class="radio-text">A) Iracema, de José de Alencar.</span></li>
                            <li class="radio-container"><input type="radio" name="questao-4" value="1"
                                    onclick="checkAnswer(event, 'questao-4')"><span class="radio-text">B) Macunaíma, de Mário de Andrade.</span></li>
                            <li class="radio-container"><input type="radio" name="questao-4" value="0"
                                    onclick="checkAnswer(event, 'questao-4')"><span class="radio-text">C) Memórias Póstumas de Brás Cubas, de Machado de Assis.</span></li>
                            <li class="radio-container"><input type="radio" name="questao-4" value="0"
                                    onclick="checkAnswer(event, 'questao-4')"><span class="radio-text">D) O Guarani, de José de Alencar.</span></li>
                            <li class="radio-container"><input type="radio" name="questao-4" value="0"
                                    onclick="checkAnswer(event, 'questao-4')"><span class="radio-text">E) Os Sertões, de Euclides da Cunha.</span></li>
                        </ul>
                        <ul class="text-black">
                            <li class="mb-2">
                                <p>5) O Simbolismo é conhecido pelo uso de figuras de linguagem que evocam sensações. Qual dos recursos abaixo é frequentemente associado a esse movimento?</p>
                            </li>
                            <li class="radio-container"><input type="radio" name="questao-5" value="1"
                                    onclick="checkAnswer(event, 'questao-5')"><span class="radio-text">A) Sinestesia.</span></li>
                            <li class="radio-container"><input type="radio" name="questao-5" value="0"
                                    onclick="checkAnswer(event, 'questao-5')"><span class="radio-text">B) Aliteração.</span></li>
                            <li class="radio-container"><input type="radio" name="questao-5" value="0"
                                    onclick="checkAnswer(event, 'questao-5')"><span class="radio-text">C) Hipérbole.</span></li>
                            <li class="radio-container"><input type="radio" name="questao-5" value="0"
                                    onclick="checkAnswer(event, 'questao-5')"><span class="radio-text">D) Metáfora.</span></li>
                            <li class="radio-container"><input type="radio" name="questao-5" value="0"
                                    onclick="checkAnswer(event, 'questao-5')"><span class="radio-text">E) Paradoxo.</span></li>
                        </ul>
                    </div>
