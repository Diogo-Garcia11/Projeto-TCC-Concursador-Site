    ...
    <div class="py-12">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            ...
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg p-[80px]">
                ...
                <p class="text-black">Na Matemática, função corresponde a uma associação dos elementos de dois conjuntos, ou seja, a função indica como os elementos estão relacionados.
...
<br><br> <span class="font-bold">Exemplo: </span>observe os conjuntos A = {1, 2, 3, 4} e B = {1, 2, 3, 4, 5, 6, 7, 8}, com a função que determina a relação entre os elementos f: A → B é x → 2x. Sendo assim, f(x) = 2x e cada x do conjunto A é transformado em 2x no conjunto B.
