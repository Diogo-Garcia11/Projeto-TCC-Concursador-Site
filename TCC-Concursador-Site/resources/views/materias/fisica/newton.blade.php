            ...
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg p-[80px]">
                ...
                <div class="mt-6">
                    ...
                    <div class="mt-6">
                        <ul class="text-black">
                            <li class="mb-2 mt-4">
                                <p>3) Um corpo de massa 10 kg está em repouso em uma superfície horizontal. Sabendo que a força mínima para mover o corpo é de 20 N, qual é o coeficiente de atrito estático entre o corpo e a superfície? Considere g = 10 m/s².</p>
                            </li>
                            <li class="radio-container"><input type="radio" name="questao-3" value="0" onclick="checkAnswer(event, 'questao-3')"><span class="radio-text">A) 0,05</span></li>
                            <li class="radio-container"><input type="radio" name="questao-3" value="0" onclick="checkAnswer(event, 'questao-3')"><span class="radio-text">B) 0,10</span></li>
                            <li class="radio-container"><input type="radio" name="questao-3" value="1" onclick="checkAnswer(event, 'questao-3')"><span class="radio-text">C) 0,20</span></li>
                            <li class="radio-container"><input type="radio" name="questao-3" value="0" onclick="checkAnswer(event, 'questao-3')"><span class="radio-text">D) 0,50</span></li>
                            <li class="radio-container"><input type="radio" name="questao-3" value="0" onclick="checkAnswer(event, 'questao-3')"><span class="radio-text">E) 1,00</span></li>
                        </ul>
                        <ul class="text-black">
                            <li class="mb-2 mt-4">
                                <p>4) Durante o lançamento de um foguete, gases são expelidos com grande velocidade para trás. Qual princípio físico explica a ascensão do foguete?</p>
                            </li>
                            <li class="radio-container"><input type="radio" name="questao-4" value="0" onclick="checkAnswer(event, 'questao-4')"><span class="radio-text">A) Lei da gravitação universal</span></li>
                            <li class="radio-container"><input type="radio" name="questao-4" value="0" onclick="checkAnswer(event, 'questao-4')"><span class="radio-text">B) Segunda Lei de Newton</span></li>
                            <li class="radio-container"><input type="radio" name="questao-4" value="1" onclick="checkAnswer(event, 'questao-4')"><span class="radio-text">C) Terceira Lei de Newton</span></li>
                            <li class="radio-container"><input type="radio" name="questao-4" value="0" onclick="checkAnswer(event, 'questao-4')"><span class="radio-text">D) Princípio da inércia</span></li>
                            <li class="radio-container"><input type="radio" name="questao-4" value="0" onclick="checkAnswer(event, 'questao-4')"><span class="radio-text">E) Conservação de energia</span></li>
                        </ul>
                        <ul class="text-black">
                            <li class="mb-2 mt-4">
                                <p>5) Um objeto é lançado verticalmente para cima com velocidade inicial de 20 m/s. Desprezando a resistência do ar, qual a força que atua sobre o objeto no ponto mais alto da trajetória?</p>
                            </li>
                            <li class="radio-container"><input type="radio" name="questao-5" value="0" onclick="checkAnswer(event, 'questao-5')"><span class="radio-text">A) Zero, pois a velocidade é zero.</span></li>
                            <li class="radio-container"><input type="radio" name="questao-5" value="1" onclick="checkAnswer(event, 'questao-5')"><span class="radio-text">B) Igual ao peso do objeto.</span></li>
                            <li class="radio-container"><input type="radio" name="questao-5" value="0" onclick="checkAnswer(event, 'questao-5')"><span class="radio-text">C) Igual à força de reação do solo.</span></li>
                            <li class="radio-container"><input type="radio" name="questao-5" value="0" onclick="checkAnswer(event, 'questao-5')"><span class="radio-text">D) Igual à força centrípeta.</span></li>
                            <li class="radio-container"><input type="radio" name="questao-5" value="0" onclick="checkAnswer(event, 'questao-5')"><span class="radio-text">E) Nenhuma força atua sobre o objeto.</span></li>
                        </ul>
                    </div>
