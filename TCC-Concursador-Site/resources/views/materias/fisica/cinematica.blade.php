...
<x-app-layout>
    ...
    <div class="py-12">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            ...
            <a href="{{ route('materias', ['section' => 'fisica']) }}#biologia" class="mb-4 text-gray-500 underline inline-block">Fisica</a>


            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg p-[80px]">
                <h1 class="text-3xl font-Montserrat font-bold text-black mb-[20px]">Cinematica</h1>
                <p>A cinemática é uma das áreas da física que estuda o movimento dos objetos sem se preocupar com as causas desse movimento, ou seja, sem considerar as forças que o provocam. Ela se concentra em descrever como os objetos se movem e as relações entre suas posições, velocidades e acelerações ao longo do tempo</p>
