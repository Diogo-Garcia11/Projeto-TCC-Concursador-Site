...
<x-app-layout>
  ...
  <main class="p-4">
    <div class="flex justify-center">
      <!-- Química -->
      <button id="dropdownButton" class="bg-steelblue p-6 shadow border-2 border-steelblue h-64 w-[90%] rounded-lg flex items-center">
    ...
    <!-- Dropdown -->
    <div class="flex justify-center">
      <div id="dropdownPanel" class="absolute z-10 hidden mt-2 w-[85%] bg-kblue border-2 border-steelblue rounded-lg shadow-lg grid grid-cols-3 grid-rows-3 gap-4 place-items-center">
        <div class="grid-item">
          <a href="" class="text-3xl font-Montserrat text-white p-8">➤ Atomística</a>
        </div>
        <div class="grid-item">
          <a href="" class="text-3xl font-Montserrat text-white p-8">➤ Tabela periódica</a>
        </div>
        <div class="grid-item">
          <a href="" class="text-3xl font-Montserrat text-white p-8">➤ Ligações químicas</a>
        </div>
        <div class="grid-item">
          <a href="" class="text-3xl font-Montserrat text-white p-8">➤ Oxirreduções</a>
        </div>
        <div class="grid-item">
          <a href="" class="text-3xl font-Montserrat text-white p-8">➤ Ligações químicas</a>
        </div>
        <div class="grid-item">
          <a href="" class="text-3xl font-Montserrat text-white p-8">➤ Eletroquímica</a>
        </div>
        <div class="grid-item">
          <a href="" class="text-3xl font-Montserrat text-white p-8">➤ Radioatividade</a>
        </div>
        <div class="grid-item">
          <a href="" class="text-3xl font-Montserrat text-white p-8">➤ Soluções químicas</a>
        </div>
        <div class="grid-item">
          <a href="" class="text-3xl font-Montserrat text-white p-8">➤ Estado físico da matéria</a>
        </div>
      </div>
    </div>
